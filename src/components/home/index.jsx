...
function Home() {
  ...
  useEffect(() => {
    const urlDpt = "https://gist.githubusercontent.com/diaztibata/fe3d238ee6b59ef71c8001654441a9f6/raw/4974a1b1cab3ac606dd96aa2d34d6e7c8e007daf/departamentosglobal.json";
    const urlCpt = "https://gist.githubusercontent.com/diaztibata/fe3d238ee6b59ef71c8001654441a9f6/raw/4974a1b1cab3ac606dd96aa2d34d6e7c8e007daf/capitalesglobal.json";
  ...
  return (
    <>
      ...
      <div className="filtro">
        ...
        <button onClick={() => setModo("capitales")}>
          Mostrar Capitales
        </button>
      </div>
      ...
      <div className="elementos">
        {listaFiltrada.length > 0 ? (
          listaFiltrada.map((item) => (
            <p 
              onClick={() => navigate(`/detalle/${item.id.slice(0, -1)}/${item.id}`)} 
              key={item.id}
            >
              {item.nm}
            </p>
